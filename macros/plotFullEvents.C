...
void plotFullEvents() {
    ...
    // mu-p
    createPlot("rootFiles/mup770MeVLpcOutput.root", 6, 
		  "gifFiles/mupEvent.gif", 0.0, 600.0, -300.0, 900.0, 
		  -200.0, 800.0, 0.4, 0.7, 0.5, 0.25);

    createPlot("rootFiles/mup770MeVLpcOutput.root", 6, 
		  "gifFiles/mupEventCloseup.gif", 0.0, 150.0, -250.0, 250.0, 
		  -200.0, 100.0, 0.4, 0.7, 0.7, 0.5);

    // Proton interaction
    createPlot("rootFiles/mup770MeVLpcOutput.root", 408, 
		  "gifFiles/mupInteract.gif", 0.0, 800.0, -100.0, 700.0, 
		  -100.0, 120.0, 0.45, 0.7, 0.45, 0.25);

    // e-p
    createPlot("rootFiles/ep770MeVLpcOutput.root", 69, 
		  "gifFiles/epEvent.gif", 0.0, 800.0, -100.0, 800.0, 
		  -300.0, 800.0, 0.335, 0.45, 0.475, 0.225);

    createPlot("rootFiles/ep770MeVLpcOutput.root", 69, 
		  "gifFiles/epEventCloseup.gif", -20.0, 140.0, -150.0, 250.0, 
		  -150.0, 100.0, 0.4, 0.7, 0.7, 0.4);
    // 1.5 GeV muon
    createPlot("rootFiles/muon1_5GeVLpcOutput.root", 28, 
		  "gifFiles/mu1_5GeVEvent.gif", -3000.0, 0.0, 0.0, 300.0, 
		  -6500.0, 0.0, 0.5, 0.7, 0.575, 0.235);
    
    // 1.5 GeV electron
    createPlot("rootFiles/elec1_5GeVLpcOutput.root", 28, 
		  "gifFiles/e1_5GeVEvent.gif", 0.0, 1300.0, 0.0, 120.0,
		  -250.0, 200.0, 0.5, 0.7, 0.575, 0.235);
    
}

void createPlot(string inFileName, int eventNo, 
